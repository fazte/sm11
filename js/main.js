...
document.addEventListener("keyup", function(event){
    if('b' == event.key.toLowerCase()){
        ...
        document.body.style.color = "white";
				document.querySelector('.add-button').style.color = "white";
				document.querySelector('.add-button').style.border= "1px solid white";
    }
})
...
document.addEventListener("keyup", function(event){
    if('w' == event.key.toLowerCase()){
        ...
        document.body.style.color = "black";
				document.querySelector('.add-button').style.color = "#00C170 ";
				document.querySelector('.add-button').style.border= "1px solid #00C170 ";
    }
})
